...
| **RigidBody**           | `active`, `static`, `sleeping` (Uint8); `vx`, `vy`, `ax`, `ay`, `angularVelocity`, `angularAccel`, `mass`, `invMass`, `inertia`, `invInertia`, `linearDamping`, `angularDamping`, `maxLinearSpeed`, `velocityAngle`, `speed`; `fixedRotation` (Uint8) |
