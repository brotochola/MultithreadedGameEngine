...
function assignWasmExports(wasmExports) {
  ...
  _get_step_critical_ms = Module["_get_step_critical_ms"] = wasmExports["bc"];
  _get_box2d_step_ms = Module["_get_box2d_step_ms"] = wasmExports["cc"];
  _get_harvest_wait_ms = Module["_get_harvest_wait_ms"] = wasmExports["dc"];
  _get_impulse_flush_ms = Module["_get_impulse_flush_ms"] = wasmExports["ec"];
  _get_export_ms = Module["_get_export_ms"] = wasmExports["fc"];
  _get_kick_ms = Module["_get_kick_ms"] = wasmExports["gc"];
  _get_particle_soa_copy_ms = Module["_get_particle_soa_copy_ms"] = wasmExports["hc"];
  _get_impulse_queue_len = Module["_get_impulse_queue_len"] = wasmExports["ic"];
  _get_body_contact_count = Module["_get_body_contact_count"] = wasmExports["jc"];
  _get_pthread_pool_size = Module["_get_pthread_pool_size"] = wasmExports["kc"];
  _set_liquidfun_async = Module["_set_liquidfun_async"] = wasmExports["lc"];
  _get_liquidfun_async = Module["_get_liquidfun_async"] = wasmExports["mc"];
  _get_particle_contact_count = Module["_get_particle_contact_count"] = wasmExports["nc"];
  _get_liquidfun_profile_byte_offset = Module["_get_liquidfun_profile_byte_offset"] = wasmExports["oc"];
  _get_liquidfun_profile_float_count = Module["_get_liquidfun_profile_float_count"] = wasmExports["pc"];
  _get_particle_capacity = Module["_get_particle_capacity"] = wasmExports["qc"];
  _get_particle_radius = Module["_get_particle_radius"] = wasmExports["rc"];
  _get_particle_count_byte_offset = Module["_get_particle_count_byte_offset"] = wasmExports["sc"];
  _get_particle_pos_byte_offset = Module["_get_particle_pos_byte_offset"] = wasmExports["tc"];
  _get_particle_vel_byte_offset = Module["_get_particle_vel_byte_offset"] = wasmExports["uc"];
  _get_particle_flags_byte_offset = Module["_get_particle_flags_byte_offset"] = wasmExports["vc"];
  _get_particle_x_byte_offset = Module["_get_particle_x_byte_offset"] = wasmExports["wc"];
  _get_particle_alpha_byte_offset = Module["_get_particle_alpha_byte_offset"] = wasmExports["xc"];
  _get_particle_y_byte_offset = Module["_get_particle_y_byte_offset"] = wasmExports["yc"];
  _get_particle_vx_byte_offset = Module["_get_particle_vx_byte_offset"] = wasmExports["zc"];
  _get_particle_vy_byte_offset = Module["_get_particle_vy_byte_offset"] = wasmExports["Ac"];
  _weedjs_heap_bytes_used = Module["_weedjs_heap_bytes_used"] = wasmExports["Bc"];
  __emscripten_tls_init = wasmExports["Cc"];
  _pthread_self = wasmExports["Dc"];
  __emscripten_thread_init = wasmExports["Fc"];
  ___set_thread_state = wasmExports["Gc"];
  __emscripten_thread_crashed = wasmExports["Hc"];
  __emscripten_run_js_on_main_thread_done = wasmExports["Ic"];
  __emscripten_run_js_on_main_thread = wasmExports["Jc"];
  __emscripten_thread_free_data = wasmExports["Kc"];
  __emscripten_thread_exit = wasmExports["Lc"];
  __emscripten_timeout = wasmExports["Mc"];
  __emscripten_check_mailbox = wasmExports["Nc"];
  _emscripten_stack_set_limits = wasmExports["Oc"];
  __emscripten_stack_restore = wasmExports["Pc"];
  __emscripten_stack_alloc = wasmExports["Qc"];
  _emscripten_stack_get_current = wasmExports["Rc"];
  __indirect_function_table = wasmTable = wasmExports["Ec"];
}
...
function assignWasmImports() {
  wasmImports = {
    ...
    /** @export */ q: __emscripten_notify_mailbox_postmessage,
    /** @export */ d: __emscripten_receive_on_main_thread_js,
    /** @export */ m: __emscripten_runtime_keepalive_clear,
    /** @export */ e: __emscripten_thread_cleanup,
    /** @export */ g: __emscripten_thread_mailbox_await,
    /** @export */ k: __emscripten_thread_set_strongref,
    /** @export */ n: __setitimer_js,
    /** @export */ s: _clock_time_get,
    /** @export */ c: _emscripten_check_blocking_allowed,
