...
function assignWasmExports(wasmExports) {
  ...
  _get_particle_capacity = Module["_get_particle_capacity"] = wasmExports["bc"];
  _get_particle_radius = Module["_get_particle_radius"] = wasmExports["cc"];
  _get_particle_count_byte_offset = Module["_get_particle_count_byte_offset"] = wasmExports["dc"];
  _get_particle_pos_byte_offset = Module["_get_particle_pos_byte_offset"] = wasmExports["ec"];
  _get_particle_vel_byte_offset = Module["_get_particle_vel_byte_offset"] = wasmExports["fc"];
  _get_particle_flags_byte_offset = Module["_get_particle_flags_byte_offset"] = wasmExports["gc"];
  _get_particle_x_byte_offset = Module["_get_particle_x_byte_offset"] = wasmExports["hc"];
  _get_particle_alpha_byte_offset = Module["_get_particle_alpha_byte_offset"] = wasmExports["ic"];
  _get_particle_y_byte_offset = Module["_get_particle_y_byte_offset"] = wasmExports["jc"];
  _get_particle_vx_byte_offset = Module["_get_particle_vx_byte_offset"] = wasmExports["kc"];
  _get_particle_vy_byte_offset = Module["_get_particle_vy_byte_offset"] = wasmExports["lc"];
  _weedjs_heap_bytes_used = Module["_weedjs_heap_bytes_used"] = wasmExports["mc"];
  ...
  __emscripten_timeout = wasmExports["xc"];
  __emscripten_check_mailbox = wasmExports["yc"];
  _emscripten_stack_set_limits = wasmExports["zc"];
  ...
  __indirect_function_table = wasmTable = wasmExports["pc"];
}
